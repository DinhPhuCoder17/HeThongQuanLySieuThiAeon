...
namespace Trang_chủ_Main_Page_
{
    public partial class FormAddQL : Form
    {
        ...
        private void btnTaoTaiKhoan_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(hoTen) || string.IsNullOrEmpty(cccd) || string.IsNullOrEmpty(diaChi) || string.IsNullOrEmpty(sdt) || string.IsNullOrEmpty(userName) || string.IsNullOrEmpty(password))
            {
